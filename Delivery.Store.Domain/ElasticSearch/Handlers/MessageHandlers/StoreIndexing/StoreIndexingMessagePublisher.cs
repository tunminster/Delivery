...
{
    public class StoreIndexingMessagePublisher : IMessagePublisherAsync<StoreIndexingMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public StoreIndexingMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(StoreIndexingMessageContract message)
        {
