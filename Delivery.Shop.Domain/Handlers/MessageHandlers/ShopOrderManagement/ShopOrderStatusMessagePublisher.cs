...
{
    public class ShopOrderStatusMessagePublisher : IMessagePublisherAsync<ShopOrderStatusMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public ShopOrderStatusMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(ShopOrderStatusMessageContract message)
        {
