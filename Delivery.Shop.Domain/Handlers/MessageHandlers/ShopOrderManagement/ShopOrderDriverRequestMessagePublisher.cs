...
{
    public class ShopOrderDriverRequestMessagePublisher : IMessagePublisherAsync<ShopOrderDriverRequestMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public ShopOrderDriverRequestMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(ShopOrderDriverRequestMessageContract message)
        {
