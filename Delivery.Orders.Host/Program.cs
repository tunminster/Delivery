...
using Delivery.Orders.Host.ContainerHosts;
using Delivery.Orders.Host.Kernel;
using Microsoft.Extensions.Hosting;

namespace Delivery.Orders.Host
{
        ...
        public static IHostBuilder GetHostBuilder(string[] args)
        {
            var hostBuilder = Microsoft.Extensions.Hosting.Host
                ...
                .ConfigurePlatformHosting(HostTypes.MessagingHost,
                    builder => new OrdersCompetingConsumerContainerHost(builder));
