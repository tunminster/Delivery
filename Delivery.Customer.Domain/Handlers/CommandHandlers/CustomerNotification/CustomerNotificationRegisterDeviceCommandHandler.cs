...
{
    public record CustomerNotificationRegisterDeviceCommand(RegisterDeviceModel RegisterDeviceModel);
    
    public class CustomerNotificationRegisterDeviceCommandHandler : ICommandHandler<CustomerNotificationRegisterDeviceCommand,DeviceRegistrationResponseContract>
    {
        private readonly IServiceProvider serviceProvider;
        private readonly IExecutingRequestContextAdapter executingRequestContextAdapter;

        public CustomerNotificationRegisterDeviceCommandHandler(IServiceProvider serviceProvider,
        ...
        public async Task<DeviceRegistrationResponseContract> HandleAsync(CustomerNotificationRegisterDeviceCommand command)
        {
            ...
            var deviceRegistrationCreateModel = new DeviceRegistrationCreateModel
            {
                ...
                Tag = $"{executingRequestContextAdapter.GetShard().Key}{CustomerConstant.NotificationPrefix}{NotificationTagHelper.GetTag(executingRequestContextAdapter.GetAuthenticatedUser().UserEmail!)}",
