        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportCategory = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencySign = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrencyCode = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    PaymentType = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    PaymentCard = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: true),
                    PaymentStatus = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    OrderStatus = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    PaymentOrderCodeRef = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
