...
{
    public class DriverCreationMessagePublisher : IMessagePublisherAsync<DriverCreationMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public DriverCreationMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(DriverCreationMessageContract message)
        {
