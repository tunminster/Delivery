...
{
    public class DriverAssignmentMessagePublisher : IMessagePublisherAsync<DriverAssignmentMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public DriverAssignmentMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(DriverAssignmentMessageContract message)
        {
