...
{
    public class DriverOrderIndexMessagePublisher : IMessagePublisherAsync<DriverOrderIndexMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public DriverOrderIndexMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(DriverOrderIndexMessageContract message)
        {
