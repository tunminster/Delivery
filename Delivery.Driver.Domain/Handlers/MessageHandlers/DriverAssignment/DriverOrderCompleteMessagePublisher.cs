...
{
    public class DriverOrderCompleteMessagePublisher : IMessagePublisherAsync<DriverOrderCompleteMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public DriverOrderCompleteMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(DriverOrderCompleteMessageContract message)
        {
