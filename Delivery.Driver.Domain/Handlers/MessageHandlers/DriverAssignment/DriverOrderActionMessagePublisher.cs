...
{
    public class DriverOrderActionMessagePublisher : IMessagePublisherAsync<DriverOrderActionMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public DriverOrderActionMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(DriverOrderActionMessageContract message)
        {
