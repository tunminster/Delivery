...
{
    public class SplitPaymentsMessagePublisher : IMessagePublisherAsync<SplitPaymentCreationMessageContract>
    {
        private readonly IServiceProvider serviceProvider;

        public SplitPaymentsMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(SplitPaymentCreationMessageContract message)
        {
