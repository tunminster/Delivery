...
{
    public class OrderUpdateMessagePublisher : IMessagePublisherAsync<OrderUpdateMessage>
    {
        private readonly IServiceProvider serviceProvider;

        public OrderUpdateMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(OrderUpdateMessage message)
        {
