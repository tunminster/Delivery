...
{
    public class CouponPaymentCreationMessagePublisher : IMessagePublisherAsync<CouponPaymentCreationMessage>
    {
        private readonly IServiceProvider serviceProvider;

        public CouponPaymentCreationMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(CouponPaymentCreationMessage message)
        {
