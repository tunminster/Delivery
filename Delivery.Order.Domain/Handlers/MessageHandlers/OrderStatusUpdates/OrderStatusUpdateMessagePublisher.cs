...
{
    public class OrderStatusUpdateMessagePublisher : IMessagePublisherAsync<OrderStatusUpdateMessage>
    {
        private readonly IServiceProvider serviceProvider;

        public OrderStatusUpdateMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(OrderStatusUpdateMessage message)
        {
