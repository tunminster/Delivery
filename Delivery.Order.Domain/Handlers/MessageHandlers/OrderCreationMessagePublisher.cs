...
{
    public class OrderCreationMessagePublisher : IMessagePublisherAsync<OrderCreationMessage>
    {
        private readonly IServiceProvider serviceProvider;

        public OrderCreationMessagePublisher(IServiceProvider serviceProvider)
        {
            this.serviceProvider = serviceProvider;
        }
        
        public async Task PublishAsync(OrderCreationMessage message)
        {
